    ...
    <nav class="flex-1 px-4 py-4 space-y-2">
        ...
        <a href="<?php echo $baseUrl; ?>views/stock_opname.php" class="flex items-center px-2 lg:px-3 py-2 rounded-lg transition-colors duration-200 text-sm lg:text-base
            ...
            <span class="truncate">Stock Opname</span>
                ...
                <a href="<?php echo $baseUrl; ?>views/status_anggota.php" class="flex items-center px-2 lg:px-3 py-2 rounded-lg transition-colors duration-200 text-sm lg:text-base
    <?php echo (strpos($_SERVER['PHP_SELF'], 'status_anggota.php') !== false) ? 'bg-blue-600 text-white shadow-lg' : 'hover:bg-gray-200'; ?>">
<svg class="w-5 lg:w-6 h-5 lg:h-6 mr-2 lg:mr-3 flex-shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 21V19.5C4 16.4624 6.46243 14 9.5 14H12.5C15.5376 14 18 16.4624 18 19.5V21M7 21V18M15 21V18M16.5 6L16.8367 5.49493C17.1969 4.95461 17.9371 4.82782 18.4566 5.21745C19.0073 5.63047 19.0645 6.43549 18.5778 6.92224L17.8536 7.64645C17.6272 7.87282 17.5 8.17986 17.5 8.5M17.5 10V10.2M13.8281 4.89801C14.6435 3.74945 15.9842 3 17.5 3C19.9853 3 22 5.01472 22 7.5C22 9.98528 19.9853 12 17.5 12C16.2549 12 15.1279 11.4943 14.3131 10.6771M15 8.00001C15 5.79086 13.2091 4 11 4C8.79086 4 7 5.79086 7 8.00001C7 10.2092 8.79086 12 11 12C11.8312 12 12.6032 11.7465 13.2429 11.3125C14.3033 10.5931 15 9.37794 15 8.00001Z <?php echo (strpos($_SERVER['PHP_SELF'], 'status_anggota.php') !== false) ? 'text-white' : 'text-black'; ?>" stroke="CurrentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.4"/></svg>
            <span class="truncate">Status Anggota</span>
        </a>
    </nav>
